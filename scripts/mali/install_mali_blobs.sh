...
MALI_G29_64_LATEST_DEB_URL="${MALI_G29_64_LATEST_DEB_URL:-https://github.com/ginkage/libmali-rockchip/releases/download/v1.10-1-334a20c/libmali-valhall-g610-g29p1_1.10-1_arm64.deb}"
