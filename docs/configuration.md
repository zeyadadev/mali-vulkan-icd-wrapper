...
| `WSI_ALLOW_NON_FIFO_PRESENT_MODE` | `0` | Keep requested MAILBOX/IMMEDIATE modes on X11 dmabuf paths |
...
| `XWL_DMABUF_BRIDGE_ALLOW_MAILBOX` | `0` | Deprecated alias for allowing non-FIFO bridge presentation |
